...
public class CreateInput 
{
	...
	static void createInputFile(){//used path to your project
		...
		String [][] cars = {
				{ "Toyota", "Japan","Mass-Market"},
				{"Honda", "Japan","Mass-Market"}, {"Chevrolet", "USA","Mass-Market"}, {"Ford", 
					"USA","Mass-Market"},  {"Mercedes-Benz","Germany","Luxury"}, 
				{"Jeep","USA","Mass-Market"}, 
				{"BMW","Germany","Luxury"}, {"Porsche","Germany","Luxury"}, 
				{"Subaru","Japan","Mass-Market"}, {"Nissan","Japan","Mass-Market"}, 
				{"Cadillac","USA","Luxury"}, 
				{"Volkswagen","Germany","Mass-Market"}, {"Lexus","Japan","Luxury"}, 
				{"Audi","Germany","Luxury"}, {"Ferrari","Italy","Super-Luxury"}, 
				{"Volvo", "Sweden", "Luxury"}, 
				{"Jaguar", "UK","Luxury"}, {"GMC","USA","Mass-Market"}, {"Buick","USA","Mass-Market"}, {"Acura","Japan","Luxury"}, 
					{"Bentley","UK","Super-Luxury"}, 
					{"Dodge","USA","Mass-Market"}, {"Hyundai","ROK","Mass-Market"}, 
					{"Lincoln","USA","Luxury"}, {"Mazda", "Japan","Mass-Market"}, 
					{"Land_Rover", "UK","Luxury"}, 
					{"Tesla","USA","Luxury"}, {"Maserati","Italy","Super-Luxury"}, 
					{"Aston_Martin","UK","Super-Luxury"}, {"Peugeot", "France","Mass-Market"},
					{"Renault", "France","Mass-Market"}, {"Genesis","ROK","Luxury"}, 
					//added car1 
					{"Lamborghini", "Italy", "Super-Luxury"}, 
					//added car2 
					{"Tata", "India", "Mass-Market"}, 
					//added car3 
					{"KIA", "ROK", "Mass-Market"}, 
					};
					String [] exclusiveFeatures = 
						{"Celestial_Headliner","LED_Projectors","Cabin_Atomizer_Fragrance", 
								"Massage_Seats", "Mood_Lighting", "Heated_And_Cooled_Cupholders", "Folding_Tables",
						"Satellite-Aided_Car_Transmission", "Rear_Seat_TV", "Heated_Seats", "Panoramic_Roof"}; //last three features are added
					//Print the header
					output.printf("%25s%20s\n\n","","The Car Online Marketplace Transactions Report for November, 2022, generated on " + LocalDate.now());
							output.printf("%-15s%-20s%-20s%-18s%-20s%-20s\n\n","Purchase Date", 
									"Car Brand", "Country", "Car Type", "Price, $", "Special & Exclusive Feature(s)");
									//Print the transactions based on item type
									for (int i = 0; i < dates.length; i++) {
										int index1 = (int) (Math.random()*cars.length);
										output.printf("%-15s%-20s%-20s%-15s",dates[i], "\"" + 
												cars[index1][0] + "\"", cars[index1][1], cars[index1][2]);
